 ...
 */
        //inline
        public static bool IsValidDirection(this Direction d)
        {
            return d < Direction.DIR_END;
        }
 ...
 */
        //inline
        public static bool IsValidAxis(this Axis d)
        {
            return d < Axis.AXIS_END;
        }
 ...
 */
        //inline
        public static Direction ReverseDir(this Direction d)
        {
            if (d.IsValidDirection() == false) throw new ArgumentOutOfRangeException(nameof(d));
            return (Direction) (4 ^ (int) d);
        }
         ...
         */
        //inline
        public static DirDiff DirDifference(this Direction d0, Direction d1)
        {
            if (d0.IsValidDirection() == false) throw new ArgumentOutOfRangeException(nameof(d0));
            if (d1.IsValidDirection() == false) throw new ArgumentOutOfRangeException(nameof(d1));
            ...
            return (DirDiff) (((int) d0 - (int) d1) % 8);
        }
 ...
 */
        ...
        {
            if (d.IsValidDiagDirection() == false) throw new ArgumentOutOfRangeException(nameof(d));
        ...
        {
            if (d0.IsValidDiagDirection() == false) throw new ArgumentOutOfRangeException(nameof(d0));
            if (d1.IsValidDiagDirection() == false) throw new ArgumentOutOfRangeException(nameof(d1));
            /* Cast to uint so compiler can use bitmask. Result can never be negative. */
         ...
         */
        //inline
        public static DiagDirection DirToDiagDir(this Direction dir)
        {
            if (dir.IsValidDirection() == false) throw new ArgumentOutOfRangeException(nameof(dir));
            return (DiagDirection) ((int) dir >> 1);
        }
 ...
 */
        //inline
        public static Axis OtherAxis(this Axis a)
        {
            if (a.IsValidAxis() == false) throw new ArgumentOutOfRangeException(nameof(a));
            return (Axis) ((int) a ^ 1);
        }
 ...
 */
         ...
         */
        //inline
        public static DiagDirection AxisToDiagDir(this Axis a)
        {
            if (a.IsValidAxis() == false) throw new ArgumentOutOfRangeException(nameof(a));
         ...
         */
        //inline
        public static Direction AxisToDirection(this Axis a)
        {
            if (a.IsValidAxis() == false) throw new ArgumentOutOfRangeException(nameof(a));
            return (Direction) (5 - 2 * (int) a);
        }
 ...
 */
        //inline
        public static bool IsDiagonalDirection(this Direction dir)
        {
            if (dir.IsValidDirection() == false) throw new ArgumentOutOfRangeException(nameof(dir));
            return ((int) dir & 1) != 0;
        }
