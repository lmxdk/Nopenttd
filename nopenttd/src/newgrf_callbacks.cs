 ...
 */
    public enum VehicleCallbackMask
    {
        /// Visual effects and wagon power (trains, road vehicles and ships)
        CBM_VEHICLE_VISUAL_EFFECT = 0,

        /// Vehicle length (trains and road vehicles)
        CBM_VEHICLE_LENGTH = 1,

        /// Load amount
        CBM_VEHICLE_LOAD_AMOUNT = 2,

        /// Cargo capacity after refit
        CBM_VEHICLE_REFIT_CAPACITY = 3,

        /// Add articulated engines (trains and road vehicles)
        CBM_VEHICLE_ARTIC_ENGINE = 4,

        /// Show suffix after cargo name
        CBM_VEHICLE_CARGO_SUFFIX = 5,

        /// Change colour mapping of vehicle
        CBM_VEHICLE_COLOUR_REMAP = 6,

        /// Vehicle uses custom sound effects
        CBM_VEHICLE_SOUND_EFFECT = 7,
    }

/**
 * Callback masks for stations.
 */
    public enum StationCallbackMask
    {
        /// Availability of station in construction window
        CBM_STATION_AVAIL = 0,

        /// Use callback to select a sprite layout to use
        CBM_STATION_SPRITE_LAYOUT = 1,

        /// Use a custom next frame callback
        CBM_STATION_ANIMATION_NEXT_FRAME = 2,

        /// Customize the animation speed of the station
        CBM_STATION_ANIMATION_SPEED = 3,
 ...
 */
    public enum CanalCallbackMask
    {
        /// Enable add sprite offset callback
        CBM_CANAL_SPRITE_OFFSET = 0,
    }

/**
 * Callback masks for cargoes.
 */
    public enum CargoCallbackMask
    {
 ...
 */
    public enum IndustryCallbackMask
    {
        /// industry availability/probability callback
        CBM_IND_PROBABILITY = 0,

        /// call production callback when cargo arrives at the industry
        CBM_IND_PRODUCTION_CARGO_ARRIVAL = 1,

        /// call production callback every 256 ticks
        CBM_IND_PRODUCTION_256_TICKS = 2,

        /// check industry construction on given area
        CBM_IND_LOCATION = 3,

        /// controls random production change
        CBM_IND_PRODUCTION_CHANGE = 4,

        /// controls monthly random production change
        CBM_IND_MONTHLYPROD_CHANGE = 5,

        /// cargo sub-type display
        CBM_IND_CARGO_SUFFIX = 6,

        /// additional text in fund window
        CBM_IND_FUND_MORE_TEXT = 7,

        /// additional text in industry window
        CBM_IND_WINDOW_MORE_TEXT = 8,

        /// control special effects
        CBM_IND_SPECIAL_EFFECT = 9,

        /// option out of accepting cargo
        CBM_IND_REFUSE_CARGO = 10,

        /// give a custom colour to newly build industries
        CBM_IND_DECIDE_COLOUR = 11,

        /// customize the cargoes the industry requires
        CBM_IND_INPUT_CARGO_TYPES = 12,

        /// customize the cargoes the industry produces
        CBM_IND_OUTPUT_CARGO_TYPES = 13,

        /// initialise production level on construction
        CBM_IND_PROD_CHANGE_BUILD = 14,
    }

/**
 * Callback masks for industry tiles
 */
    public enum IndustryTileCallbackMask
    {
        /// decides next animation frame
        CBM_INDT_ANIM_NEXT_FRAME = 0,

        /// decides animation speed
        CBM_INDT_ANIM_SPEED = 1,

        /// decides amount of cargo acceptance
        CBM_INDT_CARGO_ACCEPTANCE = 2,

        /// decides accepted types
        CBM_INDT_ACCEPT_CARGO = 3,

        /// decides slope suitability
        CBM_INDT_SHAPE_CHECK = 4,

        /// decides if default foundations need to be drawn
        CBM_INDT_DRAW_FOUNDATIONS = 5,

        /// decides allowance of autosloping
        CBM_INDT_AUTOSLOPE = 6,
    }

/**
 * Callback masks for objects
 */
    public enum ObjectCallbackMask
    {
        /// decides slope suitability
        CBM_OBJ_SLOPE_CHECK = 0,

        /// decides next animation frame
        CBM_OBJ_ANIMATION_NEXT_FRAME = 1,

        /// decides animation speed
        CBM_OBJ_ANIMATION_SPEED = 2,

        /// decide the colour of the building
        CBM_OBJ_COLOUR = 3,

        /// additional text in fund window
        CBM_OBJ_FUND_MORE_TEXT = 4,
 ...
 */
    public enum AirportTileCallbackMask
    {
        /// decides next animation frame
        CBM_AIRT_ANIM_NEXT_FRAME = 0,

        /// decides animation speed 
        CBM_AIRT_ANIM_SPEED = 1,

        /// decides slope suitability 
        CBM_AIRT_SHAPE_CHECK = 4,

        /// decides if default foundations need to be drawn 
        CBM_AIRT_DRAW_FOUNDATIONS = 5,
     ...
     */
    public class NewgrfCallbacks
    {
        /// Result of a failed callback.
		public const uint CALLBACK_FAILED = 0xFFFF;

        /// Sentinel indicating that the loop for CBID_HOUSE_PRODUCE_CARGO has ended
        public const uint CALLBACK_HOUSEPRODCARGO_END = 0x20FF;
    }
