...
/** %Window numbers. */
    ...
    public enum WindowNumberEnum
    {
        /// AI settings.
        WN_GAME_OPTIONS_AI = 0,
        ...
        /// Network join status.
        WN_NETWORK_STATUS_WINDOW_JOIN = 0,
...
/** Data value for #Window::OnInvalidateData() of windows with class #WC_GAME_OPTIONS. */
    ...
    public enum GameOptionsInvalidationData
    {
        GOID_DEFAULT = 0,
...
/** Number to differentiate different windows of the same class */
    ...
    public struct WindowNumber
    {
        ...
        public WindowNumber(int id)
        {
            Id = id;
        }

        public static implicit operator int(WindowNumber id)
        {
            return id.Id;
        }

        public static implicit operator WindowNumber(int id)
        {
            return new WindowNumber(id);
        }
    }
